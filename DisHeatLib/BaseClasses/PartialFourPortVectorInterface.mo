...
partial model PartialFourPortVectorInterface
  "Partial model transporting fluid between two ports without storing mass or energy"
  extends DisHeatLib.BaseClasses.PartialFourPortVector;
  ...
  Medium1.MassFlowRate m1_flow = port_a1.m_flow
    "Mass flow rate from port_a1 to ports_b1 (m1_flow > 0 is design flow direction)";
  Modelica.SIunits.PressureDifference dp1(displayUnit="Pa") = port_a1.p - ports_b1[1].p
    "Pressure difference between port_a1 and ports_b1[1]";

  Medium2.MassFlowRate m2_flow = port_a2.m_flow
    "Mass flow rate from port_a2 to ports_b2 (m2_flow > 0 is design flow direction)";
  Modelica.SIunits.PressureDifference dp2(displayUnit="Pa") = port_a2.p - ports_b2[1].p
    "Pressure difference between port_a2 and ports_b2[1]";
  ...
  Medium1.ThermodynamicState sta_b1[nPorts1]=
      Medium1.setState_phX(ports_b1.p,
  ...
  Medium2.ThermodynamicState sta_b2[nPorts2]=
      Medium2.setState_phX(ports_b2.p,
                           noEvent(actualStream(ports_b2.h_outflow)),
                           noEvent(actualStream(ports_b2.Xi_outflow))) if
         show_T "Medium properties in ports_b2";
...
end PartialFourPortVectorInterface;
