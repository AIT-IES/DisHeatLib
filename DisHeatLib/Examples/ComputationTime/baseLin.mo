...
model baseLin
  ...
  // Buildings
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building1(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building2(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building3(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building4(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building5(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building6(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building7(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building8(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building9(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building10(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building11(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building12(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building13(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRValLin Building14(
    redeclare package Medium = Medium,
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{200,180}})), Icon(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Examples/ComputationTime/BaseLinSimulateWeekSparse.mos"
        "Simulate 1 week sparse", file=
          "Resources/Scripts/Dymola/Examples/ComputationTime/BaseLinSimulateWeekNoSparse.mos"
        "Simulate 1 week no sparse"),
    Documentation(info="<html>
<p>In this example the flag &quot;linearizeFlowResistance&quot; has been set to true. Therefor the equations are simplified, since the solver uses a linear function to calculate flow resistance, instead of having to consider physical phenomena like turbulent flow, etc.</p>
<p>It uses the building model &quot;BuildingFRValLin&quot;.</p>
<p>To achieve the change of the flag double-click the pipesl in the example, then open the tab &quot;Flow resistance&quot; and set the flag &quot;linearizeFlowResistance&quot; to true. Repeat the same steps in the used building model for the the demand stations and the substation.</p>
