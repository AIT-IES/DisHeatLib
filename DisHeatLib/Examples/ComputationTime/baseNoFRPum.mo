...
model baseNoFRPum
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building2(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building3(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building4(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building5(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building6(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building7(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building8(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building9(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building10(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building11(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building12(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building13(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRPum Building14(
    redeclare package Medium = Medium,
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{200,180}})), Icon(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Examples/ComputationTime/BaseNoFRPumSimulateWeekSparse.mos"
...
<p>This example combines the computation optimizations of baseNoFR and basePum.</p>
<p>It uses the building model &quot;buildingNoFRPum&quot;.</p>
