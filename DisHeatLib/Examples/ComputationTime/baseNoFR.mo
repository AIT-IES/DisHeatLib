...
model baseNoFR
  ...
  parameter Modelica.SIunits.Temperature TemSup_nominal = 70.0 + 273.15
  ...
  DisHeatLib.Pipes.DualPipe Pipe1(
    ...
    m_flow_small=1E-3*abs(Pipe1.m1_flow_nominal),
    L=60,
    ...
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe2.m1_flow_nominal),
    L=220,
    T_sl_init=TemSup_nominal,
  ...
  DisHeatLib.Pipes.DualPipe Pipe3(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe3.m1_flow_nominal),
    L=250,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN50 pipeType,
    nPorts2=1,
  ...
  DisHeatLib.Pipes.DualPipe Pipe4(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe4.m1_flow_nominal),
    L=50,
    T_sl_init=TemSup_nominal,
  ...
  DisHeatLib.Pipes.DualPipe Pipe5(
    redeclare package Medium = Medium,
    m_flow_small=1E-3*abs(Pipe5.m1_flow_nominal),
    L=70,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN32 pipeType,
    nPorts2=1,
  ...
  DisHeatLib.Pipes.DualPipe Pipe6(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe6.m1_flow_nominal),
    L=310,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN50 pipeType,
    nPorts2=1,
  ...
  DisHeatLib.Pipes.DualPipe Pipe7(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe7.m1_flow_nominal),
    L=80,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN32 pipeType,
    nPorts2=1,
  ...
  DisHeatLib.Pipes.DualPipe Pipe8(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe8.m1_flow_nominal),
    T_sl_init=TemSup_nominal,
    L=120,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN32 pipeType,
    nPorts1=1,
  ...
  DisHeatLib.Pipes.DualPipe Pipe9(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe9.m1_flow_nominal),
    T_sl_init=TemSup_nominal,
    L=110,
  ...
  DisHeatLib.Pipes.DualPipe Pipe10(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe10.m1_flow_nominal),
    L=170,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN50 pipeType,
    nPorts2=1,
  ...
  DisHeatLib.Pipes.DualPipe Pipe11(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_small=1E-3*abs(Pipe11.m1_flow_nominal),
    L=310,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN50 pipeType,
    nPorts2=1,
  ...
  DisHeatLib.Pipes.DualPipe Pipe12(
    redeclare package Medium = Medium,
    m_flow_small=1E-3*abs(Pipe12.m1_flow_nominal),
    L=90,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_1IMP_DN32 pipeType,
    nPorts2=1,
  ...
  // Buildings
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building1(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building2(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building3(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building4(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building5(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building6(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building7(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building8(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building9(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building10(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building11(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building12(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building13(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingNoFRVal Building14(
    redeclare package Medium = Medium,
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTemRet_Supply(
    ...
    m_flow_small=1E-3*abs(senTemRet_Supply.m_flow_nominal),
...
equation
  ...
  connect(Pipe2.ports_b1[2], Pipe3.port_a1)
    annotation (Line(points={{46,-16},{68,-16}},          color={0,127,255}));
  ...
  connect(Pipe10.ports_b1[1], Building10.port_a) annotation (Line(points={{-30,64},
          {-64,64},{-64,46},{-60,46}},                       color={0,127,255}));
  ...
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{200,180}})), Icon(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Examples/ComputationTime/BaseNoFRSimulateWeekSparse.mos"
        "Simulate 1 week sparse", file=
          "Resources/Scripts/Dymola/Examples/ComputationTime/BaseNoFRSimulateWeekNoSparse.mos"
        "Simulate 1 week no sparse"),
    Documentation(info="<html>
<p>In this example the flag &quot;allowFlowReversal&quot; has been set to false. Therefor the equations are simplified, since the solver can assume, that theflow will always go in the intended direction and the mass flow will always be positive.</p>
<p>It uses the building model &quot;BuildingNoFRVal&quot;.</p>
<p>To achieve the change of the flag in the pipes, thermometer and supply station, by double-clicking the model in the example, then open the tab &quot;assumptions&quot; and set the flag &quot;allowFlowReversal&quot; to false. Repeat the same steps in the used building model for the thermometers, the demand stations and the substation (the substation has 3 flags to be set to false).</p>
...
<li>Simulate 1 week no sparse: Simulates the model for a duration of 1 week after using the command &quot;Advanced.SparseActivate=false&quot;</li>
</ul>
</html>"));
end baseNoFR;
