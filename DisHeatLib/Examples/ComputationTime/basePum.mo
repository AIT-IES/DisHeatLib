...
model basePum
  ...
  // Buildings
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building1(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building2(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building3(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building4(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building5(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building6(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building7(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building8(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building9(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building10(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building11(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building12(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building13(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.ComputationTime.Buildings.BuildingFRPum Building14(
    redeclare package Medium = Medium,
...
equation
  ...
  connect(Pipe8.ports_b1[1], Building8.port_a) annotation (Line(points={{-64,-64},
          {-66,-64},{-66,-94},{-96,-94},{-96,-74}},                color={0,127,
          255}));
  connect(Building8.port_b, Pipe8.port_a2) annotation (Line(points={{-76,-74},{
  ...
  connect(Pipe6.ports_b1[2], Building5.port_a) annotation (Line(points={{-90,-20},
          {-130,-20},{-130,-58}},      color={0,127,255}));
  connect(Building5.port_b, Pipe6.port_a2) annotation (Line(points={{-110,-58},
          {-110,-32},{-90,-32}}, color={0,127,255}));
  ...
  connect(Pipe6.ports_b1[3], Building6.port_a) annotation (Line(points={{-90,
          -17.3333},{-132,-17.3333},{-132,-2},{-130,-2}},
                                                color={0,127,255}));
  connect(Building6.port_b, Pipe6.port_a2) annotation (Line(points={{-110,-2},{
          -104,-2},{-104,-32},{-90,-32}}, color={0,127,255}));
  connect(Pipe7.port_a2, Building7.port_b) annotation (Line(points={{-156,-38},
          {-158,-38},{-158,-18},{-150,-18},{-150,-4},{-156,-4}}, color={0,127,
          255}));
  connect(Pipe7.ports_b1[1], Building7.port_a) annotation (Line(points={{-156,
          -26},{-176,-26},{-176,-4}}, color={0,127,255}));
  ...
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{200,180}})), Icon(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Examples/ComputationTime/BasePumSimulateWeekSparse.mos"
        "Simulate 1 week sparse", file=
          "Resources/Scripts/Dymola/Examples/ComputationTime/BasePumSimulateWeekNoSparse.mos"
        "Simulate 1 week no sparse"),
    Documentation(info="<html>
<p>In this example all valves in the substations have been exchanged with pumps. Therefor the equations are simplified, since pumps dictate the mass flow instead of valves, for which their degree of opening has to be calculated from the desired mass flow and the current mass flow. </p>
<p>It uses the building model &quot;BuildingFRPum&quot;.</p>
<p>To swap valves to pumps, go to the building model, double-click the substation and repeat the following steps for &quot;bypass&quot;, &quot;baseStation1&quot; and &quot;baseStation2&quot;: Click on &quot;edit&quot; next to the &quot;bypass&quot;/&quot;baseStation1&quot;/&quot;baseStation2&quot;, then click on &quot;edit&quot; next to &quot;flowUnit&quot; and then change the &quot;FlowType&quot; to &quot;*pump&quot;.</p>
