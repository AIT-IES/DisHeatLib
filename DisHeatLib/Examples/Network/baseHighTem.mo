...
model baseHighTem
  ...
  parameter Modelica.SIunits.Temperature TemSup_nominal = 90.0 + 273.15
  ...
  DisHeatLib.Pipes.DualPipe Pipe4(
    ...
    L=50,
    T_sl_init=TemSup_nominal,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_Std_DN32 pipeType,
    nPorts2=1,
    nPorts1=1)
          annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
  ...
  DisHeatLib.Pipes.DualPipe Pipe9(
    ...
    T_sl_init=TemSup_nominal,
    L=110,
    redeclare DisHeatLib.Pipes.Library.Isoplus.Isoplus_Std_DN80 pipeType,
    nPorts2=1,
    nPorts1=3)
    annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingHighTem Building1(
    ...
    VTan=3.01,
    fileNameSH="Resources/Data/network/bld1SH.txt",
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingHighTem Building5(
    ...
    VTan=2.556,
    fileNameSH="Resources/Data/network/bld5SH.txt",
    fileNameDHW="Resources/Data/network/bld5DHW.txt",
    TemSup_nominal=TemSup_nominal)
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingHighTem Building6(
    ...
    VTan=1.436,
    fileNameSH="Resources/Data/network/bld6SH.txt",
    fileNameDHW="Resources/Data/network/bld6DHW.txt",
    TemSup_nominal=TemSup_nominal)
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingHighTem Building7(
    ...
    VTan=1.896,
    fileNameSH="Resources/Data/network/bld7SH.txt",
    fileNameDHW="Resources/Data/network/bld7DHW.txt",
    TemSup_nominal=TemSup_nominal)
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingHighTem Building8(
    ...
    VTan=1.208,
    fileNameSH="Resources/Data/network/bld8SH.txt",
    fileNameDHW="Resources/Data/network/bld8DHW.txt",
    TemSup_nominal=TemSup_nominal)
  ...
  DisHeatLib.Boundary.OutsideTemperature outsideTemperature_file(
    ...
    tableName="TempOut",
    fileName=Modelica.Utilities.Files.loadResource("Resources/Data/TempOut.txt"))
    annotation (Placement(transformation(extent={{-42,150},{-22,170}})));
equation
  // Soil connections
  ...
  connect(Pipe6.ports_b1[1], Pipe7.port_a1) annotation (Line(points={{-90,-23},
          {-94,-23},{-94,-22},{-136,-22},{-136,-26}}, color={0,127,255}));
  connect(Pipe6.ports_b1[2], Building5.port_a) annotation (Line(points={{-90,-21},
          {-128,-21},{-128,-58}},      color={0,127,255}));
  ...
  connect(Pipe6.ports_b1[3], Building6.port_a) annotation (Line(points={{-90,-19},
          {-132,-19},{-132,-2},{-128,-2}},      color={0,127,255}));
  ...
  connect(Pipe9.ports_b1[3], Pipe10.port_a1)
    annotation (Line(points={{14.6667,18},{14.6667,66},{-10,66}},
                                                        color={0,127,255}));
  connect(Pipe10.ports_b1[1], Building10.port_a) annotation (Line(points={{-30,64},
          {-46,64},{-46,64},{-64,64},{-64,46},{-60,46}},     color={0,127,255}));
  connect(Building10.port_b, Pipe10.port_a2) annotation (Line(points={{-40,46},
          {-36,46},{-36,54},{-30,54}}, color={0,127,255}));
  connect(Pipe10.ports_b1[2], Building11.port_a) annotation (Line(points={{-30,68},
          {-48,68},{-48,70},{-62,70},{-62,86}},     color={0,127,255}));
  connect(Building11.port_b, Pipe10.port_a2) annotation (Line(points={{-42,86},
          {-42,60},{-30,60},{-30,54}}, color={0,127,255}));
  ...
  connect(Building7.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-164,6},{-164,174},{-32,174},{-32,170}}, color={191,0,0}));
  connect(Building11.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-52,96},{-52,174},{-32,174},{-32,170}}, color={191,0,0}));
  connect(Building6.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-118,8},{-118,36},{-130,36},{-130,174},{-32,174},{-32,170}},
        color={191,0,0}));
  connect(Building5.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-118,-48},{-130,-48},{-130,174},{-32,174},{-32,170}}, color={
          191,0,0}));
  connect(Building8.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-84,-64},{-96,-64},{-96,-40},{-130,-40},{-130,174},{-32,174},{
          -32,170}}, color={191,0,0}));
  connect(Building3.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{158,6},{158,174},{-32,174},{-32,170}}, color={191,0,0}));
  connect(Building14.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{80,132},{80,174},{-32,174},{-32,170}}, color={191,0,0}));
  connect(Building10.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-50,56},{-50,174},{-32,174},{-32,170}}, color={191,0,0}));
  connect(Building2.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{56,18},{56,54},{158,54},{158,174},{-32,174},{-32,170}}, color=
          {191,0,0}));
  connect(Building4.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{110,36},{110,54},{158,54},{158,174},{-32,174},{-32,170}},
        color={191,0,0}));
  connect(Building1.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-42,0},{-42,20},{-118,20},{-118,36},{-130,36},{-130,174},{-32,
          174},{-32,170}}, color={191,0,0}));
  connect(Building12.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{26,124},{26,174},{-32,174},{-32,170}}, color={191,0,0}));
  connect(Building13.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{42,82},{42,174},{-32,174},{-32,170}}, color={191,0,0}));
  connect(Building9.port_ht, Building10.port_ht) annotation (Line(points={{-20,
          46},{-34,46},{-34,58},{-50,58},{-50,56}}, color={191,0,0}));
  connect(baseSupply.port_ht, outsideTemperature_file.port) annotation (Line(
        points={{-2,-82},{-42,-82},{-42,-104},{-102,-104},{-102,-52},{-96,-52},
          {-96,-40},{-130,-40},{-130,174},{-32,174},{-32,170}}, color={191,0,0}));
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{200,180}})), Icon(
    ...
    __Dymola_Commands(
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseHighTem/BaseHighTemSimulateWeek.mos"
        "Simulate 1 week",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseHighTem/BaseHighTemSimulateDay.mos"
        "Simulate 1 day",
      file(ensureSimulated=true)=
        "Resources/Scripts/Dymola/Examples/Network/baseHighTem/BaseHighTemSupplyAndDemandSpaceHeating.mos"
        "1. Plot supply and demand space heating",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseHighTem/BaseHighTemSupplyAndDemandDomesticHotWater.mos"
        "2. Plot supply and demand domestic hot water",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseHighTem/BaseHighTemBuildingSupplyAndReturnTemperature.mos"
        "3. Plot incoming and outgoing temperature",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseHighTem/BaseHighTemDifferentialPressure.mos"
        "4. Plot differential pressure",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseHighTem/BaseHighTemMassFlow.mos"
        "5. Plot mass flow",
      file=
