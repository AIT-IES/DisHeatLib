...
model baseLowTemQT
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building2(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building3(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building4(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building5(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building6(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building7(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building8(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building9(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building10(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building11(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building12(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building13(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingLowTem Building14(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Supply.Supply_QT supply_QT(
    ...
    powerCha(Q_flow={1}, P={1}),
    dp_nominal=100000,
    use_m_flow_limit=true,
    nPorts=1) annotation (Placement(transformation(extent={{42,30},{62,50}})));
  Modelica.Blocks.Sources.RealExpression m_flow(y=Building1.m_flow + Building2.m_flow
         + Building3.m_flow + Building4.m_flow + Building5.m_flow + Building6.m_flow
         + Building7.m_flow + Building8.m_flow + Building9.m_flow + Building10.m_flow
         + Building11.m_flow + Building12.m_flow + Building13.m_flow +
        Building14.m_flow)
...
equation
  ...
  connect(Building1.port_b, Pipe1.port_a2) annotation (Line(points={{-32,-10},{
          -28,-10},{-28,-12},{12,-12},{12,-50}}, color={0,127,255}));
  ...
  connect(Pipe11.ports_b2[1], Pipe9.port_a2) annotation (Line(points={{14,64},{
  ...
  connect(supply_QT.port_a, Pipe11.ports_b2[2]) annotation (Line(points={{42,40},
          {12,40},{12,54},{10,54},{10,64}}, color={0,127,255}));
  connect(supply_QT.ports_b[1], Pipe11.port_a1) annotation (Line(points={{62,40},
          {62,58},{0,58},{0,64},{-1.77636e-15,64}}, color={0,127,255}));
  connect(m_flow.y, supply_QT.m_flow_limit) annotation (Line(points={{67,56},{
          60,56},{60,52},{52,52}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{200,180}})), Icon(
    ...
    __Dymola_Commands(
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseLowTemQT/BaseLowTemQTSimulateWeek.mos"
        "Simulate 1 week",
      file=
      ...
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseLowTemQT/BaseLowTemQTSupplyAndDemandDomesticHotWater.mos"
        "2. Plot supply and demand domestic hot water",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseLowTemQT/BaseLowTemQTBuildingSupplyAndReturnTemperature.mos"
        "3. Plot incoming and outgoing temperature",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseLowTemQT/BaseLowTemQTDifferentialPressure.mos"
        "4. Plot differential pressure",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseLowTemQT/BaseLowTemQTMassFlow.mos"
        "5. Plot mass flow",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseLowTemQT/BaseLowTemQTLossAndReturnTemperature.mos"
        "6. Plot heat loss and return temperature",
      file=
          "Resources/Scripts/Dymola/Examples/Network/baseLowTemQT/BaseLowTemQTSupplyHeatAndMassFlow.mos"
        "7. Plot heat and mass flow of both supplies"),
    Documentation(info="<html>
<p>This example simulates a heat supply and consumer network made out of a base heating station, 14 buildings and 12 pipes. The nominal supply temperature has been reduced to 50&deg;C and electric booster heater have been built into the building model &quot;BuildingLowTem&quot;, that is used for this example. Additionally there is a second supply station that delivers a constant supply temperature, limited by its maximum heat and mass flow.</p>
