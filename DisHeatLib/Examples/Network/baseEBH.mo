...
model baseEBH
  ...
  // Buildings
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building1(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building2(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building3(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building4(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building5(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building6(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building7(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building8(
    redeclare package Medium = Medium,
    m_flow_nominal_DHW=0.43,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building9(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building10(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building11(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building12(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building13(
    redeclare package Medium = Medium,
  ...
  DisHeatLib.Examples.Network.Buildings.BuildingEBH Building14(
    redeclare package Medium = Medium,
...
equation
  ...
  connect(Pipe8.ports_b1[1], Building8.port_a) annotation (Line(points={{-64,-64},
          {-66,-64},{-66,-94},{-96,-94},{-96,-76},{-94,-76}},      color={0,127,
          255}));
  connect(Building8.port_b, Pipe8.port_a2) annotation (Line(points={{-74,-76},{
          -52,-76},{-52,-64}}, color={0,127,255}));
  ...
  connect(Pipe6.ports_b1[3], Building6.port_a) annotation (Line(points={{-90,
          -17.3333},{-132,-17.3333},{-132,-4},{-128,-4}},
                                                color={0,127,255}));
  connect(Building6.port_b, Pipe6.port_a2) annotation (Line(points={{-108,-4},{
          -104,-4},{-104,-32},{-90,-32}}, color={0,127,255}));
  connect(Pipe7.port_a2, Building7.port_b) annotation (Line(points={{-156,-38},
          {-158,-38},{-158,-18},{-150,-18},{-150,-6},{-154,-6}}, color={0,127,
          255}));
  connect(Pipe7.ports_b1[1], Building7.port_a) annotation (Line(points={{-156,
          -26},{-174,-26},{-174,-6}}, color={0,127,255}));
  ...
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{200,180}})), Icon(
    ...
    __Dymola_Commands(
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHSimulateWeek.mos"
        "Simulate 1 week",
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHSimulateDay.mos"
        "Simulate 1 day",
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHSupplyAndDemandSpaceHeating.mos"
        "1. Plot supply and demand space heating",
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHSupplyAndDemandDomesticHotWater.mos"
        "2. Plot supply and demand domestic hot water",
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHBuildingSupplyAndReturnTemperature.mos"
        "3. Plot incoming and outgoing temperature",
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHDifferentialPressure.mos"
        "4. Plot differential pressure",
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHMassFlow.mos"
        "5. Plot mass flow",
      file=
          "Resources/Scripts/Dymola/Examples/Network/BaseEBH/BaseEBHLossAndReturnTemperature.mos"
        "6. Plot heat loss and return temperature"),
    Documentation(info="<html>
<p>This example simulates a heat supply and consumer network made out of a base heating station, 14 buildings and 12 pipes. The nominal supply temperature is still 70&deg;C, but electric booster heater have been built into the building model &quot;BuildingEBH&quot;, that is used for this example.</p>
