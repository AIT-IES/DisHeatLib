...
model IndirectStorageTank
  ...
  DisHeatLib.Substations.BaseStations.IndirectStorageTank
                              indirectStorageTank(
    show_T=true,
...
equation
  ...
  connect(pump.port_a, cooler.port_b)
    annotation (Line(points={{10,-40},{-10,-40}},
                                                color={0,127,255}));
  connect(pump.port_b, indirectStorageTank.port_a2) annotation (Line(points={{30,
          -40},{38,-40},{38,-4.54545},{10,-4.54545}}, color={0,127,255}));
  connect(cooler.port_a, indirectStorageTank.port_b2) annotation (Line(points={{
          -30,-40},{-36,-40},{-36,-4.54545},{-10,-4.54545}}, color={0,127,255}));
  connect(bou_SL_p.ports[1], indirectStorageTank.port_a1) annotation (Line(
        points={{-36,34},{-18,34},{-18,6.36364},{-10,6.36364}}, color={0,127,255}));
  connect(indirectStorageTank.port_b1, bou_RL_p.ports[1]) annotation (Line(
        points={{10,6.36364},{14,6.36364},{14,34},{34,34}}, color={0,127,255}));
  annotation (__Dymola_Commands(file="modelica://DisHeatLib/Resources/Scripts/Dymola/Substations/BaseStations/Examples/IndirectStorageTank.mos"
        "Simulate and plot"),
