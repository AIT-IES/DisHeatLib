...
model DirectStationMixer
  ...
  DisHeatLib.Substations.BaseStations.DirectStationMixer
                             directBaseStation(
    show_T=true,
...
equation
  ...
  annotation (__Dymola_Commands(file="modelica://DisHeatLib/Resources/Scripts/Dymola/Substations/BaseStations/Examples/DirectStationMixer.mos"
        "Simulate and plot"),
