...
equation
  connect(bou_SL_p.ports[1], directBaseStation.port_sl_p) annotation (Line(
        points={{-32,-20},{-20,-20},{-20,-6},{-10,-6}}, color={0,127,255}));
  connect(directBaseStation.port_rl_p, bou_RL_p.ports[1]) annotation (Line(
        points={{10,-6},{20,-6},{20,-20},{38,-20}}, color={0,127,255}));
  ...
  connect(directBaseStation.port_sl_s, cooler.port_a) annotation (Line(points={{
          -10,6},{-22,6},{-22,6},{-30,6},{-30,40}}, color={0,127,255}));
  connect(directBaseStation.port_rl_s, pump.port_b) annotation (Line(points={{10,
          6},{18,6},{18,6},{30,6},{30,40}}, color={0,127,255}));
